...
- Early Phase 3 diagnostics commands: `console.diagnostics_get`, `script.validate`, and `compile.wait`.
- MCP-level Phase 3 orchestration now includes `compile_wait`, `patch_propose`, and the first `repair_loop_run` diagnostic-pass scaffold in the TypeScript server.
